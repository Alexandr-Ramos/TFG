...
\subsection{Spectrogram (FT) [DONE]}
...
\begin{figure}[H]
	...
	\caption{FT page showing pink noise in the External Input, the signal captured with a microphone in the Input from System, and their difference, using various averaging options.}
	\label{fig:FT Page}
\end{figure}
